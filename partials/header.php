...
<body>
	...
	<nav id="mobileNav" class="medium-and-down">
		<a href="index.php" class="logomark">
			<img src="assets/img/icons/logomark.svg">
		</a>
	</nav>
	...
	<div id="mobileNavMenu" class="medium-and-down">
		<div class="logomark-container">
			<a href="index.php">
				<img src="assets/img/icons/logomark-white.svg" class="logomark">
			</a>
		</div>
	...
	<nav id="webNav" class="large-and-up">
		<div class="sidebar-container">
			<div class="logomark-container">
				<a href="index.php">
					<img src="assets/img/icons/logomark.svg" class="logomark">
				</a>
			</div>
			<div class="menu-container">
				<div class="menu">
			...
			<div class="logotype-container">
				<a href="index.php">
					<img src="assets/img/icons/logotype.svg" class="logotype">
				</a>
			</div>
		</div>
	</nav>
